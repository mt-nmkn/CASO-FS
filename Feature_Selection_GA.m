function [Feat_Index, BestAccuracy, AllChromosomes, AllScores,besta] =  Feature_Selection_GA(input1, datafileName,num_features,Generation,indTrain,indTest)
...
%   Available: https://www.mathworks.com/matlabcentral/fileexchange/46961-binary-genetic-algorithm-feature-selection-zip
    ...
    global Data indTr indTe
%     Data  = load(datafileName); % This is available in Mathworks
    
        Data.X = datafileName(:,1:num_features);
        Data.Y = datafileName(:,num_features+1);
        indTr=indTrain;
        indTe=indTest;
